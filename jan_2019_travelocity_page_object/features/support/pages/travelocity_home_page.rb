class TravelocityHomePage
  ...
  ul(:list_of_matching_airports, :id => 'typeaheadaPlain')
  ...
  def set_dep_airport city_name, airport_details
    ...
    @browser.ul(:id => 'typeaheadaPlain').lis.each do |each_airport|
      list_of_matching_airports_list_item_element.list_item_element.each do |each_airport|
        p each_airport.text
